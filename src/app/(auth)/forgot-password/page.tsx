              ...
              >
                ...
                <div className="text-center">
                  <p className="text-white/30 text-xs">
                    Code sent to{" "}
                    <span className="text-[#00FF41] font-medium">{email}</span>
                  </p>
                </div>
                ...
                <div className="text-center">
                  {countdown > 0 ? (
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="text-[#00FF41]/70 hover:text-[#00FF41] text-xs font-medium transition-colors cursor-pointer disabled:opacity-50"
                    >
                      Resend code
                    </button>
                  )}
          ...
          {step !== "success" && (
            <div className="mt-6 text-center">
              <p className="text-white/30 text-xs">
                ...
                <Link
                  href="/login"
                  className="text-[#00FF41]/70 hover:text-[#00FF41] transition-colors font-medium"
                >
                  Sign in
                </Link>
              </p>
